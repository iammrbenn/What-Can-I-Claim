...
test('outside Nottinghamshire hides local schemes', () => {
  const out = R.evaluate({ district: 'Leeds', age: 30, relationship: 'single', youWork: 'none', otherIncome: 0, housing: 'private', rent: 600, savings: 'under6', receiving: [] });
  assert.strictEqual(out.summary.inNotts, false);
